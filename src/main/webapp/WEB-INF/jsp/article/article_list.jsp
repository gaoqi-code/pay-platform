...
<div class="page-container">
	<div class="text-c">
		<form class="layui-form" action="" >
			...
			<button type="button"  class="btn btn-success" id="addArticle"  >添加文章</button>
		</form>
	</div>
	<div id="dataMsg"></div>
...
<script type="text/javascript">
    ...
    $(function () {
            ...
            function paging(curr){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        //显示分页
                        laypage({
                            cont: 'articlePager', //容器。值支持id名、原生dom对象，jquery对象。【如该容器为】：<div id="page1"></div>
        ...
        $("#addArticle").click(function () {
            location.href = "/article/toAdd/0.html";
        });
    })
