...
<!-- 页面相关JS -->
<script type="text/javascript" src="js/app/app/appsubjectcontent_list.js"></script>
<body class="easyui-layout">
<input type="hidden" id="ct_subject_id">
		<table id="selected_table" style="height: 240px;"></table>
	...
	<table id="select_table" style="height: 240px;"></table>
