...
<div data-options="region:'center',title:'专题管理'" class="regionCenter">
	...
	<div id="detail_dialog" data-options="closed:true,modal:true,title:'专题信息'" style="width:450px;height:450px;">
	...
	<table>
			...
			<tr>
				...
				<td class="tableTdLeft" colspan="3"><textarea maxlength="200" style="width:340px;height: 80px;" id="subjectDesc"></textarea></td>
			</tr>
			<tr>	
    	...
    	<%-- 添加专题内容--%>
	<div id="subject_dialog" data-options="closed:true,modal:true,title:'详细内容'" style="width:850px;height:590px;">
		<jsp:include page="../../jsp/bluray/content_list.jsp"></jsp:include>
	</div>
<script type="text/javascript" src="js/common/jquery/jquery.ajaxupload.js"></script>
<!-- 页面相关JS -->
<script type="text/javascript" src="js/bluray/hdsubject_list.js"></script>
</body>
</html>