...
<!-- 页面相关JS -->
<script type="text/javascript" src="js/bluray/content_list.js"></script>
<body class="easyui-layout">
<input type="hidden" id="ct_subject_id">
		<table id="selected_table" style="height: 250px;"></table>
	...
	<div id="selected_dialog" data-options="closed:true,modal:true,title:'详细内容'" style="width:500px;height:360px;">
		...
		<table>
			<tr>	
				<td>顺序：</td>	
				<td>
					<input type="text" id="selected_seq" class="easyui-numberbox" 
							data-options="min:1">
				</td>
			</tr>
			<tr>	
			...
			<tr>	
				<td>状态：</td>	
				<td><select id="selected_isEffective">
