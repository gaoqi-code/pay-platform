...
<div id="container">
            <form class="layui-form" action="" id="dataForm">
                <input type="hidden" id="needRecommendId"  name="id" value="${needRecommend.id}">
                <input type="hidden"  name="needId" value="${needRecommend.needId}">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">板块</label>
                        <div class="layui-input-inline">
                            <input type="text" name="plate" value="${needRecommend.plate}" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="recommendOrder" value="${needRecommend.recommendOrder}" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    $(function () {
        layui.use(['form'], function(){
            ...
            form.on('submit(demo1)', function(data){
                $.ajax({
                    type: "POST",
                    url: "/needRecommend/addRecommend.json",
