...
<div id="container">
            <form class="layui-form" action="" id="dataForm">
                <input type="hidden" id="productRecommendId"  name="id" value="${productRecommend.id}">
                <input type="hidden"  name="productId" value="${productRecommend.productId}">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">板块</label>
                        <div class="layui-input-inline">
                            <input type="text" name="plate" value="${productRecommend.plate}" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="recommendOrder" value="${productRecommend.recommendOrder}" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    $(function () {
        layui.use(['form'], function(){
            ...
            form.on('submit(demo1)', function(data){
                $.ajax({
                    type: "POST",
                    url: "/productRecommend/addRecommend.json",
